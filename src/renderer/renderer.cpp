...
_marchDrawable(sf::Quads, 4) {
  ...
  _marchDrawable[0].color = sf::Color(0, 0, 250, 255);
  _marchDrawable[1].color = sf::Color(80, 24, 100, 255);
  _marchDrawable[2].color = sf::Color(0, 80, 80, 255);
  _marchDrawable[3].color = sf::Color(180, 0, 75, 255);
}
